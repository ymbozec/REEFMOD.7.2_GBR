...
%                     Density_to_outplant = META.outplant_species_prop .* All_reef_nb_corals_to_outplant(n)/META.coral_deployment.DeploymentArea_km2(n)/1e6;
                    % In fact just account for total reef area because outpants will be deployed on the restored cells only, so it already accounts
                    % for deployment area
                    Density_to_outplant = META.outplant_species_prop .* All_reef_nb_corals_to_outplant(n)/META.coral_deployment.Reef_area_km2(n)/1e6;
